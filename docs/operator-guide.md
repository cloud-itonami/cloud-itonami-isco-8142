...
2. Define consent and purpose categories for molder/facility records.
...
- safety-critical escalation path (machinery hazard, heat exposure,
  fume exposure, equipment condition)
- provenance for all operating records (molder and facility both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  molding-operation-execution decision, a plant-safety-clearance
